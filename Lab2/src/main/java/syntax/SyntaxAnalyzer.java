...
public class SyntaxAnalyzer {
    ...
    private void calculateFirstMap() {
        ...
        while (hasChanges) {
            ...
            for (Rule rule : ruleList) {
                List<Terminal> alphaFirstList = getFirst(rule.getToGrammarObjectsList());
    ...
    private void calculateFollowMap() {
        ...
        while (hasChanges) {
            ...
            for (Rule rule : ruleList) {
                for (int i = 0; i < rule.getToGrammarObjectsList().size(); i++) {
                    GrammarObject grammarObject = rule.getToGrammarObjectsList().get(i);
                    ...
                    List<Terminal> firstList =
                            getFirst(rule.getToGrammarObjectsList().subList(i + 1, rule.getToGrammarObjectsList().size()));
